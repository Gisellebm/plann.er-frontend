        ...
        <div className='space-y-4'>
          <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
            <div className='flex items-center gap-2 flex-1'>
              ...
              <input disabled={isGuestsInputOpen} className="outline-none bg-transparent text-lg placeholder-zinc-400 flex-1" type="text" placeholder="Para onde você vai?" />
            </div>
            <div className='flex items-center gap-2'>
              <Calendar className="h-5 w-5 text-zinc-400" />
              <input disabled={isGuestsInputOpen} className="outline-none w-40 bg-transparent text-lg placeholder-zinc-400" type="text" placeholder="Quando?" />
            </div>
          ...
          {isGuestsInputOpen && (
            <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
              <div className='flex items-center gap-2 flex-1'>
                ...
                <input className="outline-none bg-transparent text-lg placeholder-zinc-400 flex-1" type="text" placeholder="Quem estará na viagem?" />
              </div>
